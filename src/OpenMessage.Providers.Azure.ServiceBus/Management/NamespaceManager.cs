...
using ServiceBusManager = Microsoft.ServiceBus.NamespaceManager;
using OpenMessage.Providers.Azure.ServiceBus.Configuration;
using OpenMessage.Providers.Azure.ServiceBus.Conventions;
...
namespace OpenMessage.Providers.Azure.ServiceBus.Management
{
    internal sealed class NamespaceManager<T> : INamespaceManager<T>
    {
        ...
        private async Task ProvisionQueueAsync(ServiceBusManager manager, string queueName)
        {
        ...
        private async Task ProvisionSubscriptionAsync(ServiceBusManager manager, string topicName, string subscriptionName)
        {
        ...
        private async Task ProvisionTopicAsync(ServiceBusManager manager, string topicName, bool keepOperationPending = false)
        {
        ...
        private ServiceBusManager CreateServiceBusManager()
        {
            var manager = ServiceBusManager.CreateFromConnectionString(_options.ConnectionString);
